          ...
          {filteredSalons.map((salon) => (
            <Card key={salon.salon_id} className="p-6 hover:shadow-lg transition-shadow">
              <div className="space-y-4">
                ...
                {/* Action Button */}
                <Link href={`/admin/dashboard/report/${salon.salon_id}`} className="block">
      ...
      {!isLoading && salons.length > 0 && (
        <Card className="p-4 md:p-6 bg-primary/5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold mb-2">معلومات التقارير</h3>
              <ul className="text-sm text-default-600 space-y-1 list-disc list-inside">
                <li>اختر صالون لعرض التقرير التفصيلي للإيرادات والمصروفات</li>
                <li>يمكنك استخدام البحث للوصول السريع إلى صالون معين</li>
                <li>التقارير تشمل جميع العمليات المالية للصالون</li>
              </ul>
            </div>
          </div>
        </Card>
